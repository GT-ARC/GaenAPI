...
public class LOXTest {
    ...
    public void LOXTest() {
        ...
        if (!CrossoverHelper.testCrossover(new LOX(), p1, p2))
            fail();
    }
     ...
     */
    @Test
    public void LOXTestRandom() throws FileNotFoundException, MalformedJsonException, NoSuchFieldException, DataTypeNotSupportedException {
        ...
        if (!CrossoverHelper.testCrossover(new LOX(), parent1, parent2))
            fail();
